            ...
            if (data.virtualDocumentUri) {
                ...
                if (virtualCode) {
                    for (const map of context.documents.getMaps(virtualCode)) {
                        ...
                        item = service[1].transformCompletionItem?.(item) ?? (0, transform_1.transformCompletionItem)(item, embeddedRange => map.getSourceRange(embeddedRange), map.virtualFileDocument);
                    }
                }
            }
            else {
