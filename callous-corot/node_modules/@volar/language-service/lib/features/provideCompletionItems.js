        ...
        if (completionContext?.triggerKind === 3
                ...
                if (cacheData.virtualDocumentUri) {
                    ...
                    for (const map of context.documents.getMaps(virtualCode)) {
                        for (const mapped of map.getGeneratedPositions(position, data => (0, language_core_1.isCompletionEnabled)(data))) {
                            ...
                            cacheData.list = (0, transform_1.transformCompletionList)(cacheData.list, range => map.getSourceRange(range), map.virtualFileDocument);
                        }
                    }
                }
                else {
            ...
            const worker = async (document, position, map, codeInfo) => {
                for (const service of services) {
                    ...
                    if (map) {
                        completionList = (0, transform_1.transformCompletionList)(completionList, range => map.getSourceRange(range, language_core_1.isCompletionEnabled), document);
                    }
